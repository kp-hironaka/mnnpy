...
static int __Pyx_modinit_type_init_code(void) {
  ...
  __pyx_type___pyx_array.tp_vectorcall_offset = 0;
  ...
  __pyx_type___pyx_MemviewEnum.tp_vectorcall_offset = 0;
  ...
  __pyx_type___pyx_memoryview.tp_vectorcall_offset = 0;
  ...
  __pyx_type___pyx_memoryviewslice.tp_vectorcall_offset = 0;
